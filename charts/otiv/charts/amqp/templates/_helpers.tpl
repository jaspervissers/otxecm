...
{{- printf "rabbitmq-%s" .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- $repositoryName := .Values.image.name -}}
...
{{- $repositoryName := .Values.metrics.image.name -}}
...
{{- $repositoryName := .Values.volumePermissions.image.name -}}
